...
import type { ClickMetrics } from './click'
...
export interface UserBehaviorPayload {
  ...
  /** 性能指标数值 - 单位 ms */
  value: PageViewMetrics | JSErrorMetrics | NetworkMetrics | ClickMetrics | null
  timestamp: number
}

export type UserBehaviorEvent = BaseEvent<EventTypeEnum.UserBehavior, UserBehaviorPayload[]>

export type { PageViewMetrics, NetworkMetrics, ClickMetrics }
